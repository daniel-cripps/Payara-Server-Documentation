...
**
link:documentation/extended-documentation/alternate-store-for-ejb-timers.md[Alternate
...
Commands]
**
link:documentation/extended-documentation/phone-home/phone-home.md[Phone
Home]
***
...
Applications]
*** link:documentation/payara-micro/deploying/deploy-cmd-line.md[From
the Command Line]
***
